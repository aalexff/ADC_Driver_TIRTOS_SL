...
void HVAC_InicialiceADC(void)
{
    ...
    adcConfigPin(HEARTBEAT_CH, POT_PIN, adcVccVss);   // Pin AN0 para potenciómetro.
    adcCanalFinal(HEARTBEAT_CH);
}
...
void HVAC_Heartbeat(void)
{
    ...
    delay = 15000 + (100 * adcResultado(HEARTBEAT_CH) / 4);                // Lectura del ADC por medio de la función.
